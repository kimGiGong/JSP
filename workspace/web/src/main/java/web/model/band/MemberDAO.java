...
public class MemberDAO {
	...
	public void insertMember(String id, String pw, String name, String tel, String addr , String favorite) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		...
		try {
			...
			String sql = "insert into bandMember values(?, ?, ?, ?, ?, ?)"; 
			pstmt = conn.prepareStatement(sql);

...
<% 
	...
	int currentPage = Integer.parseInt(pageNum);	//	pageNum int로 형변환 ->숫자연산
...
<%	}else{	//	글이 하나라도 있으면  %>
	...
	<% 	for (int i =0 ; i<articleList.size();i++) {
			//	List에 제네릭타입을 지정안했기떄문에 get()으로 꺼내면 Object 타입으로 리턴해줌
			//	DTO로 우리가 list에 추가해 이미 DTO타입을 알기때문에 바로 형변환해서 변수에 담아주기 

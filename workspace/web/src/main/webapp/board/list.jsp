...
<body>
	...
	<h1 align="center"> 게시판 </h1>
		...
		<table>
			<tr>
				<td colspan="5">
					<% if(session.getAttribute("memId")==null){ //	비 로그인시 %>	
					<button onclick="window.location='/web/member/loginForm.jsp'">로그인</button>
					<button onclick="window.location='/web/member/signupForm.jsp'">회원가입</button>
					<% }else{ //	로그인시	%>
					<button onclick="window.location='/web/member/logout.jsp'">로그아웃</button>
					<% } %>
				</td>
			</tr>
			<tr>
